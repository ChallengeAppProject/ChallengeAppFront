...
function CreateQuestion() {
    ...
    const submitForm = (e) => {
        ...
        api.createQuestion(form).then((res) => {
            alert( res.data );
            console.log( res );
            /* setError([]); */
            navigate('/challenges');
                    ...
                    <div className='col-lg-6'>
                        <div className='card'>
                            <div className='card-header'>
                                <h5 className='txt-title-form'>Please fill the form for create a Question</h5>
                            </div>
                            <div className='card-body'>
                                <form onSubmit={submitForm}>
                                    <div className='form-group'>
                                        <label className='txt-label-form'>Question</label>
                                        <input type="text" name='challengeQuestion' onChange={handleChange} value={form.challengeQuestion} className='form-control' />
                                        <input type="text" name='imgUrl' onChange={handleChange} value={form.challengeQuestion} className='form-control' />
                                    </div>
